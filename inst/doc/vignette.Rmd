...
More details and examples in the vignettes accessible via the top-menu and the [online manual](https://cran.r-project.org/package=PowerTOST/PowerTOST.pdf "PDF") of all functions.
