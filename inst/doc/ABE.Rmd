...
From a regulatory perspective the outcome of a comparative BA study is dichotomous. <span style="background-color:#FFFF99"> Either </span> the study demonstrated bioequivalence (CI entirely within $\theta_{1},\theta_{2}$) <span style="background-color:#FFFF99"> or </span> not.^[If the CI overlaps $\theta_{1},\theta_{2}$, the outcome is indecisive (called ‘the grey zone’ by some). As long as $\theta_{0}$ lies within $\theta_{1},\theta_{2}$ you can hope to show BE in a larger sample size. However, once $\theta_{0}$ approaches one of the limits, if might be futile – even with a very small *CV*. Try\
...
Man-pages of functions used in this vignette:
  ...
  * [power.TOST.sds](../html/power.TOST.sds.html)
  * [CVCL](../html/CVCL.html)
  * [expsampleN.TOST](../html/expsampleN.TOST.html)
  * [CI.BE](../html/CI.BE.html)
  * [CVpooled](../html/CVpooled.html)
  * [CVfromCI](../html/CVfromCI.html)
