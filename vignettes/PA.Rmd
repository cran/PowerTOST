...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 4
vignette: >
  %\VignetteIndexEntry{PowerTOST &bull; Power Analysis}
...
<span class="hl">The estimated sample sizes give always the *total* number of subjects (not subject/sequence in crossovers or subjects/group in parallel designs -- like in some other software packages).</span>
